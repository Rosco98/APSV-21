...
public class Database_installation {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			s1.setName("Supi-1");
			s1.setPhone("+34111111111");
			s1.setContactName("Pepe");
			s1.setAddress("C/XXXX, 1");
			s1.setCity("Ciudad Real");
			s1.setCountry("ESP");
			s1.setPostalCode("11111");
			...
			s2.setName("Supi-2");
			s2.setPhone("+342222222");
			s2.setContactName("Manolo");
			s2.setAddress("C/YYYYY, 2");
			s2.setCity("Madrid");
			s2.setCountry("ESP");
			s2.setPostalCode("22222");
			...
			c1.setEmail("client1@gmail.com");
			c1.setPassword("client1");
			c1.setUser("Paco");
			c1.setCity("Madrid");
			c1.setCountry("ESP");
			c1.setAddress("C//ZZZZZZ, 3");
			c1.setPostalCode("33333");
			...
			c2.setEmail("client2@gmail.com");
			c2.setPassword("client2");
			c2.setUser("Maria");
			c2.setCity("Madrid");
			c2.setCountry("ESP");
			c2.setAddress("C//WWWWWW, 4");
			c2.setPostalCode("44444");

			
			c3.setId((long) (Math.random()*100000));
			c3.setEmail("client3@gmail.com");
			c3.setPassword("client3");
			c3.setUser("Juan");
			c3.setCity("Madrid");
			c3.setCountry("ESP");
			c3.setAddress("C//33333, 3");
